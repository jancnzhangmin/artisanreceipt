...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-content x-cards" xid="content1" style="padding-top:0px;"><div xid="div1" class="gradient" bind-click="div1Click"><div component="$UI/system/components/justep/row/row" class="x-row" xid="row8">
   <div class="x-col " xid="col22"></div>
   <div class="x-col text-center" xid="col23">
    <div xid="div113">
     <img src="../image/head.png" alt="" xid="image37" class="headimg"></img></div> 
    <div xid="div112">
  ...
  <ul xid="ul2" class="list-group"><li xid="li2" class="list-group-item" style="padding:0px;" bind-click="li2Click"><div component="$UI/system/components/justep/row/row" class="x-row" xid="row1">
   <div class="x-col x-col-fixed text-center" xid="col1" style="width:20px;"><i xid="i1" class="fa fa-heart" style="color:#007cfc;"></i></div>
  ...
  <li xid="li3" class="list-group-item" style="padding:0px;" bind-click="li3Click">
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2">
    <div class="x-col x-col-fixed text-center" xid="col6" style="width:20px;">
     <i xid="i3" class="fa fa-cny" style="color:#5cc7fb;"></i></div> 
    <div class="x-col" xid="col4">
     <span xid="span4"><![CDATA[保证金]]></span></div> 
    <div class="x-col text-right" xid="col5">
     <span xid="span5"><![CDATA[0元]]></span><i xid="i4" class="fa fa-chevron-right" style="width:20px;"></i>
  </div> </div> </li>
  <li xid="li4" class="list-group-item" style="padding:0px;" bind-click="li4Click">
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3">
    <div class="x-col x-col-fixed text-center" xid="col7" style="width:20px;">
  ...
  <li xid="li5" class="list-group-item" style="padding:0px;" bind-click="li5Click">
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
    <div class="x-col x-col-fixed text-center" xid="col12" style="width:20px;">
  ...
  <li xid="li6" class="list-group-item" style="padding:0px;" bind-click="li6Click">
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row5">
    <div class="x-col x-col-fixed text-center" xid="col13" style="width:20px;">
     <i xid="i20" class="fa fa-credit-card-alt" style="color:#e3493f;"></i></div> 
    <div class="x-col" xid="col15">
     <span xid="span10"><![CDATA[提现]]></span></div> 
    <div class="x-col text-right" xid="col14">
     <span xid="span11"><![CDATA[0元]]></span>
     <i xid="i19" class="fa fa-chevron-right" style="width:20px;"></i></div> </div> </li></ul></div>
  </div> 
